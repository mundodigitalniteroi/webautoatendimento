...
@Component({
  selector: 'app-payment-confirmed-estadia',
  templateUrl: './payment-confirmed-estadia.page.html',
  styleUrls: ['./payment-confirmed-estadia.page.scss'],
})
export class PaymentConfirmedEstadiaPage implements OnInit {
  optionsConsulta;
  valorTotal;
  tempo;
  segundos = 120;
