...
import { SetDocumentUpload, SetProtocol } from 'src/app/state/registro/registro.action';
  ...
  save(){
    ...
    const atendimentoCompleto = {
      responsavel: atendimento?.tipoAtendimentoId == '1' || atendimento.tipoPessoaId != 2 ? null :  {
        ...
        cpfCnpj: atendimento?.tipoAtendimentoId == '2' ? '' : atendimento?.empresa?.cnpj,
        cnh: atendimento?.tipoAtendimentoId == '2' ? atendimento?.procuradorPf?.cnh : "",
        dataNascimento: atendimento?.tipoAtendimentoId == '2' ? moment(atendimento?.procuradorPf?.dataNascimento ).format() : "",
        telefone: atendimento?.tipoAtendimentoId == '2' ? atendimento?.procuradorPf?.telefone : "",
        email: atendimento?.tipoAtendimentoId == '2' ? atendimento?.procuradorPf?.email : "",
        ...
        endereco: {
          ...
          cidade: atendimento?.enderecoPJ?.cidade ? atendimento?.enderecoPJ?.cidade : "",
          estado: atendimento?.enderecoPJ?.estado ? atendimento?.enderecoPJ?.estado : "",
          cep: atendimento?.enderecoPJ?.cep ? atendimento?.enderecoPJ?.cep : "",
          latitude: 0,
          longitude: 0
        },
        enderecoId: 0
      ...
      pessoa: {
        nome: atendimento?.proprietarioPf?.nome ? atendimento?.proprietarioPf?.nome : "",
        cpfCnpj: atendimento?.proprietarioPf?.cpf ? atendimento?.proprietarioPf?.cpf : "",
        cnh: atendimento?.proprietarioPf?.cnh ? atendimento?.proprietarioPf?.cnh : "",
        dataNascimento: atendimento?.proprietarioPf?.dataNascimento  ?  moment(atendimento?.proprietarioPf?.dataNascimento).format() : "",
        telefone: atendimento?.proprietarioPf?.telefone ? atendimento?.proprietarioPf?.telefone : "",
        email: atendimento?.proprietarioPf?.email ? atendimento?.proprietarioPf?.email : "",
        tipoPessoaId: atendimento?.tipoPessoaId ? atendimento?.tipoPessoaId : "",
        endereco: {
          enderecoId: 0,
          logradouro: "",
          ...
          cidade: atendimento?.enderecoPF?.cidade ? atendimento?.enderecoPF?.cidade : "",
          estado: atendimento?.enderecoPF?.estado ? atendimento?.enderecoPF?.estado : "",
      ...
      tipoAtendimentoId: atendimento?.tipoAtendimentoId ? atendimento?.tipoAtendimentoId : "",
      foto: {
      nome: "ReconhecimentoFacial.jpg",
        tipo: atendimento?.fotoFacial?.tipo ? atendimento?.fotoFacial?.tipo : "",
        tamanho: 0,
        base64: atendimento?.fotoFacial?.base64 ? atendimento?.fotoFacial?.base64 : "",
      },
      terminalId: informacoesLogin?.terminalId ? informacoesLogin?.terminalId : "",
      referencia: atendimento?.informacaoConsulta?.numeroProcesso ? atendimento?.informacaoConsulta?.numeroProcesso : "",
      documentos: [
        // {
        //   tipoDocumentoId: 0,
        //   nome: "string",
